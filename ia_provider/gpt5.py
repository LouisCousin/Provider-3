...
===============================================
Implémentation spécifique pour la famille GPT-5 avec reasoning_effort et verbosity.
"""
...
# =============================================================================
# Provider GPT-5 (nouvelle génération avec raisonnement)
# =============================================================================

class GPT5Provider(BaseProvider):
    """
    Provider spécifique pour GPT-5 avec ses paramètres uniques.
